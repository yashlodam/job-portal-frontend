...
export default function RecruiterCompanyPage() {
  ...
  return (
      ...
      action={
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-2xl bg-primary/15 border border-primary/30 px-4 py-2.5 text-xs font-bold text-primary-light hover:bg-primary/25 transition cursor-pointer font-satoshi"
          >
    ...
    >
      ...
      {/* Edit Form Drawer */}
      {isEditing ? (
        <Card className="p-6 sm:p-8 border-border bg-surface shadow-2xl font-satoshi">
          <form onSubmit={handleSaveCompany} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm font-satoshi">
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Company Name *</label>
                <input
                  type="text"
                  name="companyName"
                  required
                  ...
                  className="w-full rounded-2xl border border-border bg-surface-elevated px-4 py-2.5 text-sm text-heading font-bold outline-none focus:border-primary transition shadow-inner"
                />
              </div>

              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Industry Sector *</label>
                <input
                  type="text"
                  name="industry"
                  required
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Website URL</label>
                <input
                  type="url"
                  name="website"
                  ...
                  className="w-full rounded-2xl border border-border bg-surface-elevated px-4 py-2.5 text-sm text-heading font-semibold outline-none focus:border-primary transition shadow-inner"
                />
              </div>

              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Headquarters Location</label>
                <input
                  type="text"
                  name="headquarters"
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Company Size</label>
                <input
                  type="text"
                  name="companySize"
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Founded Year</label>
                <input
                  type="text"
                  name="foundedYear"
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Contact Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Contact Phone</label>
                <input
                  type="text"
                  name="phone"
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Company Description</label>
                <textarea
                  name="description"
                  rows={3}
                  ...
                  className="w-full rounded-2xl border border-border bg-surface-elevated p-4 text-sm text-heading leading-relaxed font-medium outline-none focus:border-primary transition shadow-inner"
                />
              </div>

              <div className="sm:col-span-2">
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Company Mission Statement</label>
                <textarea
                  name="mission"
                  rows={2}
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs font-black uppercase tracking-wider text-primary-light mb-1.5">Perks & Employee Benefits</label>
                <textarea
                  name="benefits"
                  rows={2}
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-border">
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-2xl gradient-bg-signature px-6 py-3 text-xs font-black uppercase tracking-wider text-white shadow-lg hover:scale-105 transition cursor-pointer font-satoshi"
              >
          ...
          <Card className="p-6 sm:p-8 border-border bg-surface shadow-2xl space-y-6">
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <div className="relative group shrink-0">
                <div className="flex h-24 w-24 items-center justify-center rounded-3xl gradient-bg-signature text-white shadow-xl overflow-hidden font-extrabold text-4xl">
              ...
              <div className="flex-1 space-y-2">
                <div className="flex flex-wrap items-center gap-3">
                  <h2 className="text-2xl sm:text-3xl font-black text-heading font-satoshi">{company.companyName}</h2>
                  <Badge variant="success" icon={ShieldCheck}>
                    Verified Enterprise
                  </Badge>
                </div>
                <p className="text-sm text-body max-w-3xl leading-relaxed font-medium">{company.description}</p>

                <div className="pt-2 flex flex-wrap gap-5 text-xs text-body font-satoshi font-semibold">
                  <span className="flex items-center gap-1.5"><Building2 className="h-4 w-4 text-primary-light" /> {company.industry}</span>
                  <span className="flex items-center gap-1.5"><MapPin className="h-4 w-4 text-primary-light" /> {company.headquarters || company.location}</span>
                  <span className="flex items-center gap-1.5"><Users className="h-4 w-4 text-primary-light" /> {company.companySize}</span>
                  {company.foundedYear && (
                    <span className="flex items-center gap-1.5"><Calendar className="h-4 w-4 text-primary-light" /> Founded {company.foundedYear}</span>
                  )}
                  {company.website && (
                    <a href={company.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 font-extrabold text-primary-light hover:text-heading transition">
                      <Globe className="h-4 w-4 text-primary-light" /> {company.website}
                    </a>
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-border">
              <div className="p-4 rounded-2xl bg-surface-elevated border border-border space-y-1">
                <span className="text-xs font-black text-primary-light uppercase tracking-widest flex items-center gap-1.5">
                  <Target size={14} /> Company Mission
                </span>
                <p className="text-xs text-body leading-relaxed font-medium">{company.mission || "Empowering developers through intelligent automation."}</p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-surface-elevated border border-border space-y-1">
                ...
                <p className="text-xs text-body leading-relaxed font-medium">{company.benefits || "Competitive Salary, Stock Options, Remote Work, Health Insurance."}</p>
              </div>
            </div>
          </Card>
        </div>
      ...
      <Card className="border-border bg-surface font-satoshi">
        <CardHeader>
          <div className="flex items-center justify-between w-full">
            <CardTitle className="font-satoshi text-base font-black text-heading">Recruiter Team Members</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3">
          <div className="flex items-center gap-3.5 p-4 rounded-2xl border border-border bg-surface-elevated">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary/20 text-primary-light font-black text-base shadow-md">
              {(user?.name || "R").charAt(0)}
            </div>
            <div>
              <h4 className="text-sm font-extrabold text-heading font-satoshi">{user?.name || "Lead Recruiter"}</h4>
              <p className="text-xs text-primary-light font-bold">Recruiter Admin</p>
              <p className="text-xs text-muted">{user?.email || company.email || "recruiter@company.com"}</p>
            </div>
          </div>
        </CardContent>
      </Card>
